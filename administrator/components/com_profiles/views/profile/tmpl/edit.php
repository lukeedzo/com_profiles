...
$document->addStyleSheet(Uri::root() . 'media/com_profiles/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_profiles&layout=edit&id=' . (int) $this->item->id); ?>"
	...
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'profile', JText::_('COM_PROFILES_TAB_PROFILE', true)); ?>
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo JText::_('COM_PROFILES_FIELDSET_'); ?></legend>
				<?php echo $this->form->renderField('name'); ?>
				<?php echo $this->form->renderField('degree'); ?>
				<?php echo $this->form->renderField('e_mail'); ?>
				<?php echo $this->form->renderField('positions'); ?>
				<?php echo $this->form->renderField('publication_list'); ?>
				<?php echo $this->form->renderField('external_profiles'); ?>
			</fieldset>
		</div>
	</div>
